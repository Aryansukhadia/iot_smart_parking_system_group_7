...
const char *WIFI_SSID = "SWARA 1st GTPL_4G";
const char *WIFI_PASS = "7600091092";
const char *BACKEND_BASE = "http://192.168.113.67:3000/api"; // IMPORTANT: Change to your backend's IP address
